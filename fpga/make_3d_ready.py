...
`pcb_tool.kicad_writer.KicadWriter` emits minimal footprints (pads only), which are
...
Run with system python (KiCad's pcbnew module):
  python3 pardal-pcb/fpga/make_3d_ready.py \
    pardal-pcb/fpga/fpga_routed_with_widths.kicad_pcb \
    pardal-pcb/fpga/fpga_routed_with_widths.lib.kicad_pcb
"""

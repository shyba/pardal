...
class RouteCommand(Command):
    ...
    def validate(self, board: Board) -> str | None:
        ...
        from pardal.data_model import VALID_COPPER_LAYERS
...
class AutoRouteCommand(Command):
    ...
    def validate(self, board: Board) -> str | None:
        ...
        if missing_pads:
            ...
            msg += "\n\nHint: Footprints may not be in library. Check pardal/footprint_library.py"
            return error(msg)
    ...
    def execute_result(self, board: Board):
        ...
        """
        from pardal.routing import MultiNetRouter, NetDefinition
        from pardal.routing.results import RouteResult
    ...
    def _retry_failed_multipoint_edges(
        ...
        """
        from pardal.routing import NetDefinition, RoutedNet
    ...
    def _create_routing_grid(self, board: Board):
        ...
        """
        from pardal.routing.grid_builder import (
            GridBuildConfig,
    ...
    def _extract_net_definitions(self, board: Board, net_names: list[str]) -> list:
        ...
        """
        from pardal.routing.net_definitions import extract_net_definitions
    ...
    def _create_minimum_spanning_tree(self, points: list[tuple]) -> list[tuple]:
        ...
        """
        from pardal.routing.net_definitions import build_minimum_spanning_tree
...
class OptimizeRoutingCommand(Command):
    ...
    def execute(self, board: Board) -> str:
        ...
        """
        from pardal.routing import LayerOptimizer, NetPath, RoutingGrid

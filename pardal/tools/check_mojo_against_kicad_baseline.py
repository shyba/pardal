...
`tests/fixtures/parity_fixtures/baselines/<fixture_id>/baseline.json` as the spec.
"""
...
from pardal.freerouting_backend import run_kicad9_drc
from pardal.api.route_kicad_docker import route_kicad_via_docker


_FIXTURE_DEFAULT_CFG: dict[str, str] = {
    "Issue269-min_fr_test__min_fr_test.kicad_pcb": "tests/fixtures/parity_fixtures/mojo_cfgs/issue269_strict_parity.json",
    "Issue269-NoViasOnPowerPlanes__Issue269-NoViasOnPowerPlanes.kicad_pcb": "tests/fixtures/parity_fixtures/mojo_cfgs/issue269_strict_parity.json",
}
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--baselines-root", type=Path, default=Path("tests/fixtures/parity_fixtures/baselines"))

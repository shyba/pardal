...
from pardal.freerouting_backend import (
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument(
        "--out-root",
        type=Path,
        default=REPO_ROOT / "tests/fixtures/parity_fixtures" / "baselines",
        help="Where to write baselines (default: tests/fixtures/parity_fixtures/baselines/)",
    )

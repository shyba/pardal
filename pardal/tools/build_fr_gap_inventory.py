...
DEFAULT_CASES_JSONS = [
    PROJECT_ROOT / "tests/fixtures/parity_fixtures" / "fr_runtime_feature_cases.json",
    PROJECT_ROOT / "tests/fixtures/parity_fixtures" / "fr_runtime_feature_cases_fpga_large.json",
]
DEFAULT_WORKLIST = PROJECT_ROOT / "parity_worklist.json"
VENV_PY = PROJECT_ROOT / "venv" / "bin" / "python"
EXTRACT_TOOL = PROJECT_ROOT / "pardal" / "tools" / "extract_fr_runtime_features.py"
MOJO_CAPTURE_TOOL = PROJECT_ROOT / "pardal" / "tools" / "capture_mojo_trace.py"
...
def _recommended_probe(feature_key: str, fixture_hint: str, net_hint: str) -> str:
    return (
        f"./venv/bin/python pardal/tools/capture_mojo_trace.py --fixtures-json <single-fixture-manifest> "

...
from pcb_tool.data_model import Board, NetClass, Net, Component, Pad
from pcb_tool.footprint_templates import generate_pads, get_template
...
class AutoRouteStrategyCommand(Command):
    ...
    def validate(self, board: Board) -> str | None:
        """Validate command parameters."""
        from pcb_tool.routing_strategies import STRATEGIES, auto_select_strategy
    ...
    def execute(self, board: Board) -> str:
        """Execute the command."""
        from pcb_tool.routing_strategies import route_board, auto_select_strategy

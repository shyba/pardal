...
from pcb_tool.tools.run_parity_fixture import FixtureSummary, append_parity_diary_entry, run_fixture

TIER_TO_FILE: dict[str, str] = {
    "applicable": "parity_fixtures/parity_applicable_now.json",
...
def _default_tier_core(workspace_root: Path, project_root: Path) -> list[dict[str, Any]]:
    core_json = project_root / "parity_fixtures" / "parity_core.json"
    if core_json.exists():
    ...
    return [
        {
            ...
            "mojo_cfg": str(project_root / "parity_fixtures" / "mojo_cfgs" / "issue180_core_pinned.json"),
            "mojo_resolution": 0.1,
            "mojo_budget_s": 120,
        ...
        },
        {
            ...
            "pcb": str(project_root / "fpga" / "fpga_unrouted.kicad_pcb"),
            "freerouting_max_passes": 5,
            "freerouting_job_timeout": "00:02:00",
            "mojo_cfg": str(
                project_root / "parity_fixtures" / "mojo_cfgs" / "fpga_small_escape_legalize_nobatch_m20.json"
            ),
            "mojo_resolution": 0.2,
            "mojo_budget_s": 240,
        },
        {
            ...
            "pcb": str(project_root / "fpga_large" / "fpga_large_rust_strict_fast_0p2.kicad_pcb"),
            "freerouting_max_passes": 50,
            "freerouting_job_timeout": "00:10:00",
            "mojo_cfg": str(project_root / "fpga_large" / "mojo_cfg_ncr_fast_keepouts_nooverlap.json"),
            "mojo_resolution": 0.2,
            "mojo_budget_s": 60,
        },
        {
            ...
            "freerouting_max_passes": 5,
            "freerouting_job_timeout": "00:05:00",
            "mojo_cfg": str(project_root / "parity_fixtures" / "mojo_cfgs" / "issue269_strict_parity.json"),
            "mojo_resolution": 0.2,
            "mojo_budget_s": 240,
        },
    ]
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.gate_policy_json is not None:
        ...
        gate_policy_path = (project_root / "parity_fixtures" / "parity_gate_policy.json").resolve()

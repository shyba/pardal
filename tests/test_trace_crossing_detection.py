...
def test_segments_intersect_perpendicular_crossing():
    ...
    seg1 = TraceSegment(
        net_name="NET1", start=(0.0, 10.0), end=(20.0, 10.0), layer="F.Cu", width=0.25
    )

    # Create vertical segment from (10, 0) to (10, 20)
    seg2 = TraceSegment(
        net_name="NET2", start=(10.0, 0.0), end=(10.0, 20.0), layer="F.Cu", width=0.25
    )
...
def test_segments_intersect_diagonal_crossing():
    ...
    seg1 = TraceSegment(
        net_name="NET1", start=(0.0, 0.0), end=(20.0, 20.0), layer="F.Cu", width=0.25
    )

    # Create segment from (0, 20) to (20, 0)
    seg2 = TraceSegment(
        net_name="NET2", start=(0.0, 20.0), end=(20.0, 0.0), layer="F.Cu", width=0.25
    )
...
def test_segments_intersect_parallel_segments_no_intersection():
    ...
    seg2 = TraceSegment(
        net_name="NET2", start=(0.0, 12.0), end=(20.0, 12.0), layer="F.Cu", width=0.25
    )
...
def test_segments_intersect_non_intersecting_perpendicular():
    ...
    seg1 = TraceSegment(
        net_name="NET1", start=(0.0, 10.0), end=(8.0, 10.0), layer="F.Cu", width=0.25
    )
...
def test_segments_intersect_touching_at_endpoint():
    ...
    seg1 = TraceSegment(
        net_name="NET1", start=(0.0, 0.0), end=(10.0, 10.0), layer="F.Cu", width=0.25
    )

    # Create segment from (10, 10) to (20, 0)
    # Starts where seg1 ends
    seg2 = TraceSegment(
        net_name="NET2", start=(10.0, 10.0), end=(20.0, 0.0), layer="F.Cu", width=0.25
    )
...
def test_segments_intersect_crossing_at_midpoint():
    ...
    seg1 = TraceSegment(
        net_name="NET1", start=(5.0, 0.0), end=(5.0, 20.0), layer="F.Cu", width=0.25
    )

    # Create segment from (0, 10) to (10, 10)
    seg2 = TraceSegment(
        net_name="NET2", start=(0.0, 10.0), end=(10.0, 10.0), layer="F.Cu", width=0.25
    )
...
def test_segments_intersect_angled_crossing():
    ...
    seg1 = TraceSegment(
        net_name="NET1", start=(0.0, 5.0), end=(20.0, 15.0), layer="F.Cu", width=0.25
    )

    # Create segment from (0, 15) to (20, 5)
    seg2 = TraceSegment(
        net_name="NET2", start=(0.0, 15.0), end=(20.0, 5.0), layer="F.Cu", width=0.25
    )
...
def test_check_trace_overlaps_multiple_crossings(sample_board):
    ...
    seg3 = TraceSegment(
        net_name="NET1", start=(30.0, 30.0), end=(50.0, 30.0), layer="F.Cu", width=0.25
    )
    sample_board.nets["NET1"].add_segment(seg3)

    seg4 = TraceSegment(
        net_name="NET2", start=(40.0, 20.0), end=(40.0, 40.0), layer="F.Cu", width=0.25
    )
...
def test_check_trace_overlaps_no_crossings(sample_board):
    ...
    seg2 = TraceSegment(
        net_name="NET2", start=(0.0, 15.0), end=(20.0, 15.0), layer="F.Cu", width=0.25
    )
    sample_board.nets["NET2"].add_segment(seg2)
...
def test_check_trace_overlaps_crossing_coordinates_reported(sample_board):
    ...
    seg1 = TraceSegment(
        net_name="NET1", start=(0.0, 25.0), end=(50.0, 25.0), layer="F.Cu", width=0.25
    )
    sample_board.nets["NET1"].add_segment(seg1)

    seg2 = TraceSegment(
        net_name="NET2", start=(30.0, 10.0), end=(30.0, 40.0), layer="F.Cu", width=0.25
    )
    sample_board.nets["NET2"].add_segment(seg2)
...
def test_check_trace_overlaps_edge_case_barely_missing():
    ...
    seg1 = TraceSegment(
        net_name="NET1", start=(0.0, 10.0), end=(9.99, 10.0), layer="F.Cu", width=0.25
    )
...
def test_segments_intersect_collinear_overlapping():
    ...
    seg1 = TraceSegment(
        net_name="NET1", start=(0.0, 10.0), end=(15.0, 10.0), layer="F.Cu", width=0.25
    )

    seg2 = TraceSegment(
        net_name="NET2", start=(10.0, 10.0), end=(20.0, 10.0), layer="F.Cu", width=0.25
    )

...
def sample_board():
    ...
    board.add_component(
        Component(
            ref="U1", value="IC", footprint="DIP-8", position=(50, 40), rotation=0
        )
    )
    board.add_component(
        Component(
            ref="R1", value="10k", footprint="R_0805", position=(60, 50), rotation=0
        )
    )
    board.add_component(
        Component(
            ref="C1", value="100n", footprint="C_0805", position=(70, 30), rotation=0
        )
    )
    return board

import pytest
from pardal.commands import ListNetsCommand
...
def sample_board():
    ...
    board.add_component(
        Component(ref="U1", value="IC", footprint="DIP-8", position=(0, 0), rotation=0)
    )
    board.add_component(
        Component(
            ref="R1", value="10k", footprint="R_0805", position=(10, 10), rotation=0
        )
    )
    board.add_component(
        Component(
            ref="C1", value="100n", footprint="C_0805", position=(20, 20), rotation=0
        )
    )

...
from pardal.api import check_internal_drc
from pardal.routing_strategies import FourLayerFPGA
...
def main():
    ...
    print(
        f"  /usr/bin/python3 -m pardal.finalize {output_path} {output_dir}/fpga_4layer_final.kicad_pcb"
    )
